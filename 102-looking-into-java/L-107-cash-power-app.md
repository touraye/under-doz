...
Tip: Create class `DateAndTime`, `main()`method, and copy and past statement after statement
...
Note: *Start small and proceed, fixing bugs in a smaller application is more easier than in a larger application*
